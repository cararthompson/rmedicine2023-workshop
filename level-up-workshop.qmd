...
themed_plot +
  ...
  ggtext::geom_textbox(aes(
    label = paste0("<span style=font-size:12pt>", 
                   dose, "mg/day</span><br>", 
                   janitor::round_half_up(mean_length), "mm"),
    hjust = case_when(mean_length < 15 ~ 0,
                      TRUE ~ 1),
    halign = case_when(mean_length < 15 ~ 0,
                       TRUE ~ 1),
...
# Wait, but why again?  {background=#2C3D4F}

`new_data %>% penguin_plot()`

![](images/penguin-plot.gif)
...
Dataviz Design Systems <span style=color:#28A569>|</span> Dataviz Commissions <span style=color:#28A569>|</span> Training & Consultations
</center>
